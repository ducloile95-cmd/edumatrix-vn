...
import { CheckCircle2, Cloud, CreditCard, ExternalLink, Facebook, LockKeyhole, PlugZap, RefreshCw, Unplug } from "lucide-react";
...
export function IntegrationsWorkspace() {
  ...
  return <div className="space-y-4">
    ...
    <section className="grid gap-4 xl:grid-cols-[1.15fr_1fr_1fr]" aria-label="Trạng thái tích hợp">
      ...
      <IntegrationCard icon={<Facebook size={19} />} title="Facebook & Messenger" description="Kết nối bằng tài khoản Facebook, chọn Fanpage và cấp quyền cho EduMatrix qua luồng xác thực chính thức của Meta." configured={messengerReady} detail={settings.data?.facebookPageName ? `${settings.data.facebookPageName} · ${form.facebookPageId}` : form.facebookPageId ? `Page ID: ${form.facebookPageId}` : "Chưa kết nối Fanpage"}>
