...
function SparkOverview() {
  ...
  return <div className="space-y-4">
    <div className="flex flex-col gap-3 rounded-card border border-success-100 bg-success-50 p-4 sm:flex-row sm:items-center sm:justify-between"><div className="flex items-center gap-3"><span className="flex size-10 shrink-0 items-center justify-center rounded-input bg-white text-success-700 ring-1 ring-success-100"><ShieldCheck size={19} /></span><p className="text-sm font-bold text-success-900">Firebase Console là nguồn số liệu sử dụng chính thức.</p></div><a href={consoleUrl} target="_blank" rel="noreferrer" className="inline-flex min-h-touch shrink-0 items-center justify-center gap-2 rounded-input border border-success-200 bg-white px-4 text-sm font-semibold text-success-800 hover:bg-success-100"><ExternalLink size={15} />Mở Firebase Console</a></div>
    <Panel title="Hạn mức Firebase Spark"><div className="grid gap-3 p-4 sm:grid-cols-3"><QuotaCard icon={Database} label="Document reads mỗi ngày" limit="50.000" /><QuotaCard icon={Cloud} label="Document writes mỗi ngày" limit="20.000" /><QuotaCard icon={Trash2} label="Document deletes mỗi ngày" limit="20.000" /></div></Panel>
  </div>;
}
